...
if not cmp_nvim_lsp then
	print("Cmp Lspconfig didn't load!")
	return
end

-- For better looking diagnostics
M.setup = function()
	local signs = {
...
-- Keymaps for files with lsp servers
...
-- Default capabilities for the lsp servers
M.capabilities = cmp_nvim_lsp.default_capabilities()

-- Setup when loading the file with a lsp server
M.on_attach = function(client, bufnr)
	-- Removing formatting from lsp servers
